<?php
/**
 * PayPal PPCP API Wrapper for Magento 2.2.3
...
class Api
{
    ...
    const PAYPAL_PARTNER_ATTRIBUTION_ID_VALUE  = 'Meinereitwelt_Cart_PPCP';
    ...
    /**
     * Execute an HTTP request against the PayPal API
     *
